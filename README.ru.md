...
- **Не гасит экран** — по желанию, одна галочка.
...
- **Один файл Swift**, ~520 строк, без зависимостей, без фонового демона, без телеметрии.
...
| **Правый клик** | Меню: экран, автозапуск, вход в систему, правило `sudo` |
...
macOS 13 Ventura или новее. Apple Silicon и Intel.
