...
На настольном Mac и когда система не сообщает внятный уровень заряда не срабатывает ничего:
выключить режим по причине, которую приложение не может назвать, хуже, чем не трогать его.
